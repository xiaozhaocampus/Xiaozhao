...
/**
 * Class Errors is wrapper for linux <tt>errno</tt>.
 * @author antoniochen
 */
public final class Errors {
     ...
     * code passed in the argument <em>errno</em>.
     * @param errno The system errno.
     * @return The error string of the <em>errno</em>.
     */
